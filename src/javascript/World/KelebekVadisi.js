...
export default class KelebekVadisi {
  constructor({ scene, resources, objects, physics, debug, rotateX = 0, rotateY = 0, rotateZ = 0, areas = null, materials = null }) {
    ...
    this.buttonPosition = new THREE.Vector3(52.7, -18.05, 0); // Buton pozisyonu güncellendi
  ...
  setupButton() {
    ...
    this.infoPanel.innerHTML = `
      ...
      <p style="margin: 0 0 10px 0;">Konya'nın benzersiz kelebek vadisi, doğal güzelliği ve çeşitli kelebek türleriyle ziyaretçilerine unutulmaz bir deneyim sunuyor.</p>
      <a href="https://konyatropikalkelebekbahcesi.com/tr" target="_blank" style="color: #4285f4; text-decoration: none; font-weight: bold;">Daha Fazla Bilgi →</a>
    `
    ...
    if (this.areas) {
      ...
      this.interactiveArea.on('in', () => {
        ...
        this.enterKeyListener = (event) => {
          if (event.key === 'Enter') {
            window.open('https://konyatropikalkelebekbahcesi.com/tr', '_blank');
          }
        };
