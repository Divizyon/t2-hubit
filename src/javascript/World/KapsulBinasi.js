...
export default class KapsulBinasi {
  constructor({ scene, resources, objects, physics, debug, materials, areas, rotateX = 0, rotateY = 0, rotateZ = 0 }) {
    this.scene = scene;
    ...
    this.buttonPosition = new THREE.Vector3(32.5, -21.7, 0);
  ...
  _buildModel() {
    ...
    if (!gltf || !gltf.scene) {
      console.error('Kapsül bina modeli bulunamadı');
      return;
    }
  ...
  setupButton() {
    ...
    this.infoPanel.innerHTML = `
      ...
      <p style="margin: 0 0 10px 0;">Hubit Kampüsünün önemli bir parçası olan Kapsül Binası, modern tasarımı ve özel mimarisiyle bilimsel ve teknolojik etkinliklere ev sahipliği yapar.</p>
      <a href="https://www.konya.bel.tr" target="_blank" style="color: #4285f4; text-decoration: none; font-weight: bold;">Daha Fazla Bilgi →</a>
    `;
    ...
    if (this.areas) {
      ...
      // Enter'a basıldığında veya tıklandığında linke git
