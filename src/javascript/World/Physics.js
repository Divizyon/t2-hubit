...
export default class Physics
{
    ...
    setCar()
    {
        ...
        this.car.options.wheelBackOffsetDepth = - 0.70
        ...
        if(this.config && this.config.togg) {
            ...
            this.car.options.wheelFrontLeftPosition = { depth: 0.67, width: 0.65 };  // Sol ön - genişlik 0.50'den 0.65'e
            this.car.options.wheelFrontRightPosition = { depth: 0.67, width: -0.65 }; // Sağ ön - genişlik -0.50'den -0.65'e
            this.car.options.wheelBackLeftPosition = { depth: -0.67, width: 0.65 };   // Sol arka - genişlik 0.50'den 0.65'e
            this.car.options.wheelBackRightPosition = { depth: -0.67, width: -0.65 };  // Sağ arka - genişlik -0.50'den -0.65'e
        } else {
            // Normal araba için tekerlek ayarları
            this.car.options.wheelFrontLeftPosition = { depth: 0.635, width: 0.90 };   // Sol ön - genişlik 0.75'ten 0.90'a
            this.car.options.wheelFrontRightPosition = { depth: 0.635, width: -0.90 };  // Sağ ön - genişlik -0.75'ten -0.90'a
            this.car.options.wheelBackLeftPosition = { depth: -0.475, width: 0.90 };    // Sol arka - genişlik 0.75'ten 0.90'a
            this.car.options.wheelBackRightPosition = { depth: -0.475, width: -0.90 };   // Sağ arka - genişlik -0.75'ten -0.90'a
        }
