    ...
    this.infoPanel.innerHTML = `
      <div style="position: relative; width: 100%;">
        ...
        <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; padding: 10px; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center;">
          <h3 style="margin: 0 0 5px 0; color: #000000; font-size: 18px; font-weight: bold;">Sia</h3>
          <p style="margin: 0; color: #000000; font-size: 12px; line-height: 1.2; max-width: 85%;">Sosyal İnovasyon Ajansı</p>
        </div>
      </div>
    `
