...
export default class GenclikMerkezi {
  constructor({ scene, resources, objects, physics, debug, rotateX = 90, rotateY = 0, rotateZ = 0, areas = null, materials = null }) {
    this.scene = scene;
    ...
    this.buttonPosition = new THREE.Vector3(49, -37, 0); // Buton pozisyonu güncellendi
  ...
  setupButton() {
    ...
    this.infoPanel.innerHTML = `
      ...
      <p style="margin: 0 0 10px 0;">Konya'nın gençlik merkezi, eğitim, kültür ve sosyal aktivitelerle gençlerin gelişimine katkı sağlıyor.</p>
      <a href="https://genckultur.com/" target="_blank" style="color: #4285f4; text-decoration: none; font-weight: bold;">Daha Fazla Bilgi →</a>
    `
